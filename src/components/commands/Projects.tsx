...
const projects = [
  ...
  },
  {
    id: 10,
    title: "Grocery Shop Application",
    desc: "This project features a comprehensive backend service for a grocery shop application built with Express.js and MySQL, incorporating JWT authentication, filtering, pagination, cart and wishlist functionality, product liking, and order processing. Additionally, it includes a frontend application initially created from a pre-developed template, which was migrated from HTML, CSS, and vanilla JavaScript to Next.js. After refactoring, the frontend was successfully integrated with the backend.",
    url: "https://github.com/skandarchahbouni/grocery_shop_backend",
  }
];
